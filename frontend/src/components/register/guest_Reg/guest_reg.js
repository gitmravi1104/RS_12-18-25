        ...
        >
          ...
          {registrationDetails ? (
            <>
              ...
              <Typography>
                <strong>Placement Screening Test:</strong> {registrationDetails.megadriveStatus}
              </Typography>
      ...
      >
        {({ isSubmitting, setFieldValue }) => (
          <Form className="w-100 intern_reg_section" autoComplete="off">
            ...
            <div className="intern_reg_form_group">
              <FormControl component="fieldset">
                <FormLabel component="legend" required style={{ color: "white" }}>Placement Screening test</FormLabel>
                <Field
                  as={RadioGroup}
