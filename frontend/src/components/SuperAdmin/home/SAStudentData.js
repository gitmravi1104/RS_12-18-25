...
const SAStudentDetails = ({ candidateID }) => {
  ...
  return (
    <div>
      {isIntern ?
        (
          <Link to='/SA_dash/allInterns' className='text-decoration-none'>
              ...
              <Table>
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>{formatDate(studentData.endDate)}</TableCell>
                  </TableRow>
...
// import { FaFilePdf } from 'react-icons/fa';
// import apiService from '../../../apiService';
// import { Table, Modal, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Box, Typography, ListItem, ListItemIcon, ListItemText, IconButton, Collapse, Divider, List, Grid, Card, CardContent, Badge } from '@mui/material';
// import { styled } from '@mui/system';
// import CloseIcon from "@mui/icons-material/Close";
// import CheckCircleIcon from "@mui/icons-material/CheckCircle";
// import CancelIcon from "@mui/icons-material/Cancel";
...
//         </span>
//         {studentData ? (
//           <Box sx={{ flex: 1, p: 3, width: 800 }}>
//             <Table>
//               <TableBody>
//                 <TableRow>
//                   <TableCell style={{ fontWeight: "bold" }}>CandidateID</TableCell>
//                   <TableCell>{studentData.candidateID || studentData.guestID}</TableCell>
//                 </TableRow>
//                 <TableRow>
...
//                 <TableRow>
//                   <TableCell style={{ fontWeight: "bold" }}>Parent/Guardian Mobile</TableCell>
//                   <TableCell>{studentData.altmobileno || studentData.altMobileNo}</TableCell>
//                 </TableRow>
//                 <TableRow>
...
//                 </TableRow>
//                 <TableRow>
//                   <TableCell style={{ fontWeight: "bold" }}>Vasavi Foundation</TableCell>
//                   <TableCell>{studentData.belongedToVasaviFoundation || studentData.BelongedToVasaviFoundation}</TableCell>
//                 </TableRow>
//                 <TableRow>
//                   <TableCell style={{ fontWeight: "bold" }}>Batch No</TableCell>
//                   <TableCell>{studentData.batchNo || studentData.batchno}</TableCell>
//                 </TableRow>
//                 <TableRow>
//                   <TableCell style={{ fontWeight: "bold" }}>Mode of Internship</TableCell>
//                   <TableCell>{studentData.modeOfInternship || studentData.modeOfTraining}</TableCell>
//                 </TableRow>
