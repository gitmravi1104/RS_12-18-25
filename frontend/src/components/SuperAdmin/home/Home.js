...
const HrPortal = () => {
  const [statistics, setStatistics] = useState([
    ...
    { title: 'Total Students Delayed', value: 0, link: '/sa_dash/delayed', color: '#459746ff', element: IoPersonAddSharp },
  ...
  useEffect(() => {
    const fetchStatistics = async () => {
      try {
        ...
        const delayedResponse = await apiService.get(`/api/statistics/delayed`);
