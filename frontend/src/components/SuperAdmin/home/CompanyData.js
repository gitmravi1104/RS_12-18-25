...
//   const handleChangeComapanyHR = async (companyID, hrId) => {
//     try {
//       const response = await apiService.post('/api/handleChangeComapanyHR', { companyID, hrId });
//       toast.success('HR Updated successfully', {
//         autoClose: 5000
//       });

//     } catch (error) {
//       toast.error(`${error.response?.data?.message || 'Error updating HR'}`, {
//         autoClose: 5000
//       });
//     }
//   };
...
//                   <th style={{ backgroundColor: '#1b74a8', color: 'white' }}>Email</th>
//                   <th style={{ backgroundColor: '#1b74a8', color: 'white' }}>Phone</th>
//                   <th style={{ backgroundColor: '#1b74a8', color: 'white' }}>published Hr</th>
//                   <th style={{ backgroundColor: '#1b74a8', color: 'white' }}>Website</th>
//                 </tr>
//               </thead>
//               <tbody>
...
//                   <td>{CompanyData.hrName}</td>
//                   <td>{CompanyData.email}</td>
//                   <td>{CompanyData.mobileNo}</td>
//                   {/* <td>{CompanyData.fullName}</td> */}
//                   <td>
// {hr.HRid} - {hr.fullName}
//                   </td>
