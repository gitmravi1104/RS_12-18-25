...
import Report from '../Intern_Report/internReport';
import SAExtraJobs from '../SAViewJobs/SAExtraJobs';
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { id: 'extraJobs', name: 'Extra Jobs', icon: 'fas fa-eye' },
      ]
    },
    { id: 'quiz', name: 'Quiz', icon: 'fas fa-book' },
    {
      ...
      submenu: [
        { id: 'hrJobsReport', name: 'HR Report', icon: 'fas fa-plus' },
        { id: 'placementReport', name: 'Placement Report', icon: 'fas fa-eye' },
        { id: 'domainWiseReport', name: 'Domain Report', icon: 'fas fa-plus' },
      ]
    }
  ];
