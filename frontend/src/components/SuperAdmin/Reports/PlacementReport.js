...
const PlacementReport = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const response = await apiService.get("/api/placement-stats", { params });
    ...
    const handleExport = () => {
        ...
        gridApi.exportDataAsCsv({
            fileName: `Placement_Report_${year || "All"}_${month || "All"}.csv`,
            allColumns: true
        });
    };
    ...
    const columns = useMemo(() => [
        {
            ...
            cellRenderer: (params) => (
                <a
                    href={`/SA_dash/job_desc/${params.value}`}
                    target="_blank"
                    rel="noreferrer"
        ...
        { headerName: "Placement Officer", field: "placement_officer", minWidth: 180, sortable: true, filter: true },
        {
