...
import { FaAngleRight, FaCalendarTimes } from 'react-icons/fa';
                  ...
                  <div className="card-body" >
                    <div className="d-flex justify-content-between ">
                      ...
                      <div>
                        ...
                        {<span style={{ fontWeight: '800', fontSize: "10px", color: '#ffffffff', background: "black", borderRadius: "5px", padding: "5px", height: "30px" }}><RxDotFilled />{statusInfo[job.status]}</span>}
                        {new Date(job.lastDate) < currentDate && <span style={{ fontWeight: '500', fontSize: "20px", color: '#fa3e4b', marginLeft: "5px" }}><FaCalendarTimes /> </span>}
                      </div>
                    </div>
                    <div>
