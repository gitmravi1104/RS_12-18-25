...
import { FaStopCircle, FaEdit, FaTrash, FaBan, FaEye, FaEyeSlash, FaPlane, FaPaperPlane, FaToggleOn, FaToggleOff } from 'react-icons/fa';
import { Formik, Field, Form as FormikForm, ErrorMessage } from "formik";
import * as Yup from "yup";
import AccessManagement from './InternAccess';


const InternsTable = ({ currentInterns, handleDelete, handleToggleBlock, handleAccessClick, handleEditClick, handleToggleCertificate, handleSeeCert }) => {
  ...
  const rowClassRules = {
    "row-highlight": (params) => params.node.rowIndex % 2 === 0,
  };
  ...
  const validationSchema = Yup.object({
    ...
    endDate: Yup.date()
      ...
      .test('start-end-different', 'Start Date and End Date should be different', function (value) {
        ...
        console.log("dateAccepted :", dateAccepted);
...
const InternTable = () => {
  ...
  return (
    <Container>
      <InternsTable currentInterns={interns} handleDelete={handleDelete} handleToggleBlock={handleToggleBlock} handleAccessClick={handleAccessClick} handleEditClick={handleEditClick} handleToggleCertificate={handleToggleCertificate} handleSeeCert={handleSeeCert} />
      <EditModal
        show={showEditModal}
...
// const InternsTable = ({ currentInterns, handleDelete, handleToggleBlock, handleEditClick, handleToggleCertificate, handleSeeCert }) => {
//   const [gridApi, setGridApi] = useState(null);
...
//   return (
//     <Container>
//       <InternsTable currentInterns={interns} handleDelete={handleDelete} handleToggleBlock={handleToggleBlock} handleEditClick={handleEditClick} handleToggleCertificate={handleToggleCertificate} handleSeeCert={handleSeeCert} />
//       <EditModal
//         show={showEditModal}
//         onHide={() => setShowEditModal(false)}
//         intern={editingIntern}
