...
import image1 from '../../Intern/Achievements/images/image1.png';
...
const CertificateGenerator = () => {
  ...
  const domainPositions = {
    ...
    "Digital Marketing-SEO": "Search Engine Optimization Executive",
    "Digital Marketing-SMO": "Social Media Optimization Executive"
  };
  ...
  `/api/generate-certificate-id/${encodeURIComponent(domain)}/${monthString}`
);
  ...
  const handleSubmit = async (values) => {
    try {
      CertificateDetails.certificationId = certificationId;
      ...
      <div className='Certificate_Generator' style={{ marginTop: "30px" }}>
        ...
        {showCertificate && (
          <div ref={certificateRef} className="certificate">
            ...
            <p>
              Congratulations on successfully completing your <strong>Internship</strong> in the field of 
              <strong> {domain} </strong> with our organization.
            </p>
